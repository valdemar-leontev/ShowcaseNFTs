...
const SectionWrapper = ({ banner, description, mockupImg, showBtn, title, reverse }) => {
  return (
        ...
        ${reverse ? styles.textRight : styles.textLeft}`}>
          ...
          {showBtn && (
            <Button
              ...
              link='https://expo.dev/@mr_leonwhite/Gloryfication?serviceType=classic&distribution=expo-go'
            />
          )}
        </div>
